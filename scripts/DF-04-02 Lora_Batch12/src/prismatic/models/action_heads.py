# =============================================================================
# DF-04-03 OpenVLA-OFT Action Heads
# =============================================================================
#
# EN: This file is based on the official OpenVLA-OFT action head
#     implementation. It provides continuous L1-regression and diffusion
#     alternatives to sequential action-token prediction.
#
# EN: DF-04-03 uses L1RegressionActionHead with an 8-step action chunk
#     and a 7-D action vector per step. The diffusion classes are retained
#     for interface compatibility but are disabled by configuration.
#
# =============================================================================
