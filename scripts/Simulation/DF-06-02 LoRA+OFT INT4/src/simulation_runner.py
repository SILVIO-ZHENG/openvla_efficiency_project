# Run chunked LIBERO rollouts and write reproducible DF-06-02 NF4 records.
...
# Execute LoRA+OFT NF4 rollouts and record chunk-aware metrics.
class SimulationRunner:
    # Initialize output paths, configs, and invocation state.
    def __init__(
        self,
        config: Mapping[str, Any],
        policy: LoraOFTINT4Policy,
    ...
    def _run_rollout(
        ...
        try:
            ...
            while episode_steps < max_steps:
                ...
                event = {
                    ...
                    "language_model_loaded_in_4bit": inference_info[
                        "language_model_loaded_in_4bit"
                    ],
        ...
        result = {
            ...
            "language_model_loaded_in_4bit": self.policy.quantization_audit[
                "is_loaded_in_4bit"
            ],
            "task_index": task_index,
    ...
    def _generate_summaries(
        ...
        summary = {
            ...
            "language_model_loaded_in_4bit": (
                self.policy.quantization_audit["is_loaded_in_4bit"]
            ),
