# Load DF-04-03 with an NF4 language model and predict continuous action chunks.
...
from src.int4_quantization import (
    build_int4_quantization_config,
...
# Load and execute the strict mixed-precision LoRA+OFT NF4 inference path.
class LoraOFTINT4Policy:
    ...
    # Load an NF4 OpenVLA language model and attach the BF16 LoRA adapter.
    def _load_model(self) -> Tuple[PeftModel, OpenVLAForActionPrediction]:
        ...
        quantization_config = build_int4_quantization_config(
            self.quantization_config
        )
    ...
    def predict(
        ...
        return action_chunk.copy(), {
            ...
            "language_model_loaded_in_4bit": self.quantization_audit[
                "is_loaded_in_4bit"
            ],
