# Run chunked LIBERO rollouts and write reproducible DF-06-01 INT8 records.
...
# Execute LoRA+OFT INT8 rollouts and record chunk-aware metrics.
class SimulationRunner:
    # Initialize output paths, configs, and invocation state.
    def __init__(
        self,
        config: Mapping[str, Any],
        policy: LoraOFTINT8Policy,
    ...
    def _run_rollout(
        ...
        try:
            ...
            while episode_steps < max_steps:
                    ...
                    self._write_inference_event(
                        {
                            ...
                            "quantization_backend": self.quantization_config[
                                "backend"
                            ],
                            "quantization_method": self.quantization_config[
                                "method"
                            ],
                            "language_model_loaded_in_8bit": (
                                self.policy.quantization_audit[
                                    "is_loaded_in_8bit"
                                ]
                            ),
                ...
                event = {
                    ...
                    "quantization_backend": inference_info[
                        "quantization_backend"
                    ],
                    "quantization_method": inference_info[
                        "quantization_method"
                    ],
                    "language_model_loaded_in_8bit": inference_info[
                        "language_model_loaded_in_8bit"
                    ],
        ...
        result = {
            ...
            "language_model_loaded_in_8bit": self.policy.quantization_audit[
                "is_loaded_in_8bit"
            ],
            "task_index": task_index,
    ...
    def _build_runtime_manifest(
        ...
        return {
            ...
            "quantization_audit": self.policy.quantization_audit,
            ...
            "bitsandbytes_version": self._package_version("bitsandbytes"),
            "accelerate_version": self._package_version("accelerate"),
    ...
    def _generate_summaries(
        ...
        summary = {
            ...
            "quantization_backend": self.quantization_config["backend"],
            "quantization_method": self.quantization_config["method"],
            "quantized_component": self.quantization_config[
                "quantized_component"
            ],
            "language_model_loaded_in_8bit": (
                self.policy.quantization_audit["is_loaded_in_8bit"]
            ),
            "quantization_audit_passed": self.policy.quantization_audit[
                "audit_passed"
            ],
            ...
            "model_memory_footprint_gib": self.policy.quantization_audit[
                "model_memory_footprint_gib"
            ],
            "model_load_seconds": self.policy.quantization_audit[
                "model_load_seconds"
            ],
