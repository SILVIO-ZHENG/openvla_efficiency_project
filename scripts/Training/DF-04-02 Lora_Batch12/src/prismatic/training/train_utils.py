# =============================================================================
# DF-04-03 OpenVLA-OFT Training Utilities
# =============================================================================
#
# EN: This file is based on the official OpenVLA-OFT training utilities.
#     It builds masks for the current action and future action chunk,
#     and provides token-accuracy and continuous-action L1 metrics.
#
# EN: For LIBERO, each action contains 7 dimensions and the action chunk
#     contains 8 actions, producing 56 action-token positions in total.
#
# =============================================================================
