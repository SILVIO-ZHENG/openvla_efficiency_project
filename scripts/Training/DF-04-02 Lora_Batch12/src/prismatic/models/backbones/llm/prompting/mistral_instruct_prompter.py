...
Defines a PromptBuilder for building Mistral Instruct Chat Prompts --> recommended pattern used by HFonline tutorial.s
...
class MistralInstructPromptBuilder(PromptBuilder):
    ...
    def get_potential_prompt(self, message: str) -> None:
        # Assumes that it / 's always the use / r's (human / 's) turn!
