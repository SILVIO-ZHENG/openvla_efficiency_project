...
class HFCausalLLMBackbone(LLMBackbone, ABC):
    def __init__(
        ...
        #
        # As a result we explicitly validate that a tokenizer conforms to the expected behavior; if yo / u're reading this
        # line, it / 's probably because yo / u're adding a new LLM with a different tokenizer behavior. If so, feel free to
