# =============================================================================
# DF-04-03 LoRA+OFT Data Loading and Collation Utilities
# =============================================================================
#
# EN: This file preserves the original OpenVLA language-model collator and
#     extends the action-prediction collator for OpenVLA-OFT.
#
...
#     4. Converts and stacks continuous action chunks as [B, 8, 7].
...
class PaddedCollatorForActionPrediction:
    """
    EN: OpenVLA-OFT collator for continuous action-chunk training.
    """
    ...
    expected_action_chunk_len: int = 8
    ...
    def __call__(
        ...
        """
        EN: Build one OpenVLA-OFT training batch.
        ...
        if self.use_wrist_image and not wrist_present:
            raise KeyError(
                "use_wrist_image=True, but the batch has no "
            )
        ...
        # EN: Convert and stack continuous action chunks.
