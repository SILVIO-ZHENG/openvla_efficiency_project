...
#
# Notes:
# This file is based on the official OpenVLA oxe/mixtures.py file.
# The following modification was introduced for the MSc dissertation project.
#
# Modification 1:
# Added a new named mixture:
# modified_libero_all_no_noops
#
# This mixture combines the four modified LIBERO no-noops datasets:
...
#
# Purpose:
# The official OpenVLA RLDS loader accepts one dataset_name / mixture name.
# This project needs to train LoRA on all four modified LIBERO subsets under
# the same fixed seed and split strategy, so a single combined mixture name is
# added here.
#
# Sampling weights:
# Each subset uses weight 1.0.
#
# Author:
# Silvio Zheng
#
